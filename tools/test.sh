...
mvn soafw-config:config -Dtemplate=spring-dao.xml -DartifactId=$projectid -DdestDir=../../projects/$projectid/$projectid-dao/src/main/resources/META-INF/config/spring
