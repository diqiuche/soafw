...
import com.kjt.service.common.reflection.invoker.GetFieldInvoker;
import com.kjt.service.common.reflection.invoker.Invoker;
import com.kjt.service.common.reflection.invoker.MethodInvoker;
import com.kjt.service.common.reflection.invoker.SetFieldInvoker;
import com.kjt.service.common.reflection.property.PropertyNamer;
...
public class Reflector {
    ...
    private static final Map<Class<?>, Reflector> REFLECTOR_MAP =
    ...
    private Reflector(Class<?> clazz) {
        ...
        writeablePropertyNames =
                setMethods.keySet().toArray(new String[setMethods.keySet().size()]);
    ...
    /*
     * This method returns an array containing all methods declared in this class and any
     * superclass. We use this method, instead of the simpler Class.getMethods(), because we want to
