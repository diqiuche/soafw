...
public final class StringUtils {
    ...
    public static String replaceHtmlAndJs(String input ) {
		...
		// 去掉所有html元素,
		String str = input.replaceAll("[\n\r\t]","").replaceAll("<(?!p|/p|span|/span|font|/font|br|strong|/strong|em|/em|b|/b|U|/U)(.*?)>","" ).replaceAll("<p>\\s*</p>", "");
		return str;
	}
	...
	public static String chinese2pinyin(String chinese,Map<String,String> db,boolean ishead){		
	...
	public static Map<String, Object> JSON2Map(String jsonMapStr) {  
