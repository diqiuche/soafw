...
<beans:beans xmlns="http://www.springframework.org/schema/security"
	...
	<beans:bean id="filterSecurityInterceptor" class="com.kjt.service.common.web.security.FilterSecurityInterceptor">
	...
	<beans:bean id="md5Encoder" class="com.kjt.service.common.web.security.MD5Encoder"></beans:bean>
	<!-- 访问决策器，决定某个用户具有的角色，是否有足够的权限去访问某个资源 -->
	<beans:bean id="accessDecisionManagerBean"
		class="com.kjt.service.common.web.security.AccessDecisionManager">
	</beans:bean>

	<!-- 资源源数据定义，将所有的资源和权限对应关系建立起来，即定义某一资源可以被哪些角色访问 -->
	<beans:bean id="securityMetadataSource"
		class="com.kjt.service.common.web.security.InvocationSecurityMetadataSource">

	</beans:bean>

	<beans:bean
		class="com.kjt.service.common.web.security.AjaxAwareAuthenticationEntryPoint"
