...
import com.kjt.service.common.dao.ibatis.AbsHelpper;
import com.kjt.service.common.dao.ibatis.GeneratedCriteria;
...
public class ${name}Helpper extends AbsHelpper<Criteria> {
     ...
     * (non-Javadoc)
     * 
     * @see com.kjt.service.common.dao.IHelpper#createCriteriaInternal()
     */
