...
public class DaoGenFromDB extends DaoGen {
	 ...
	 * @throws Exception
	 */
	public static void generateDAO(String dbName, String tableName, String springXml, String packageName, String targetJava, String resources)
			throws Exception {
		...
		ClassPathXmlApplicationContext cac = new ClassPathXmlApplicationContext(springXml != null ? springXml : "generateDAO.xml");
		...
		hf.process(masterDataSourceBean,slaveDataSourceBean,mapQueryDataSourceBean,packageName, targetJava, resources);
	}
