...
public class DynamicDataSource extends PoolableObjDynamicConfig implements DataSource,
  ...
  protected void build(Configuration config) {
    ...
    Integer removeAbandonedTimeout_ = config.getInt(prefix_ + "removeAbandonedTimeout");
    ...
    basicDataSource_.setMinEvictableIdleTimeMillis(minEvictableIdleTimeMillis_);
    basicDataSource_.setTestWhileIdle(testWhileIdle_);
    basicDataSource_.setTimeBetweenEvictionRunsMillis(timeBetweenEvictionRunsMillis_);
    try {
  ...
  private void verify(String prefix_, BasicDataSource basicDataSource_) {
    ...
    Environment environment = new Environment(prefix_, transactionFactory, basicDataSource_);
  ...
  private void notify(String prefix_, String message, String newCfg) {
    ...
    reloadMsgBuffer.append("时刻，机器 " + hostName + "数据库配置作了变更，但是新配置文件校验失败 ！<br>");
  ...
  public void setPoolPreparedStatements(Boolean poolPreparedStatements) {
    ((BasicDataSource) this.delegate).setPoolPreparedStatements(poolPreparedStatements);
  }
  ...
  public void setRemoveAbandonedTimeout(Integer removeAbandonedTimeout) {
    ((BasicDataSource) this.delegate).setRemoveAbandonedTimeout(removeAbandonedTimeout);
  }
  ...
  public Long getMinEvictableIdleTimeMillis() {
    return ((BasicDataSource) this.delegate).getMinEvictableIdleTimeMillis();
  }

  public void setMinEvictableIdleTimeMillis(Long minEvictableIdleTimeMillis) {
    ((BasicDataSource) this.delegate).setMinEvictableIdleTimeMillis(minEvictableIdleTimeMillis);
  }
  ...
  public Long getTimeBetweenEvictionRunsMillis() {
    return ((BasicDataSource) this.delegate).getTimeBetweenEvictionRunsMillis();
  }
